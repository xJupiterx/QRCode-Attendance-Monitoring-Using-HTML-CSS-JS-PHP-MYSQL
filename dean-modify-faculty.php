        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
				<section class="col-md-12">
					<div class="card">
						<div class="card-header" style="background-color: #3acf61; color:white"><strong><center>DEAN Account Information</center></strong></div>
						<?php
							...
							<table id="myTable" class="table table-bordered table-sm" cellspacing="0" width="100%">
								<thead>
									<tr>
										...
										<th style = "width:8%; font-size: 14px" onclick="sort(3)">Status</th>
								...
								<tbody>
									<tr>
										...
										if($row['status'] == 'ACTIVE'): ?>
                                            ...
                                            <td>
												<div class="clearfix">
													<center><input type="submit" name="edit" value="Deactivate" style = "background-color:red; color:white" onclick="return  confirm('Do you really want to DEACTIVATE this account?')"></center>
												</div>
											</td>
                                        <?php endif ?>
										<?php if($row['status'] == 'INACTIVE'): ?>
                                            ...
                                            <td>
												<div class="clearfix">
													<center><input type="submit" name="edit" value="Activate" style = "background-color:green; color:white" onclick="return  confirm('Do you really want to ACTIVATE this account?')"></center>
												</div>
											</td>
                                        <?php endif ?>
									</tr>
