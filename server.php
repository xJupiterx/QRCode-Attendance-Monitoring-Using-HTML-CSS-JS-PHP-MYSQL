...
if (isset($_POST['edit'])) {
	$editor = $_POST["edit"];
	$editoremail = $_SESSION['editemail'];
	if($editor == "Deactivate"){
		...
		if($_SESSION['accesslevel'] == 'SYSTEMADMIN'){
			echo '<script>alert("Account was successfully Deactivated!");window.location.href="systemadmin-page.php";</script>';
		}
		if($_SESSION['accesslevel'] == 'DEAN'){
			echo '<script>alert("Account was successfully Deactivated!");window.location.href="dean-page.php";</script>';
		}
	}
	if($editor == "Activate"){
		$editsql = "UPDATE user
		...
		mysqli_query($db, $editsql);
		if($_SESSION['accesslevel'] == 'SYSTEMADMIN'){
			echo '<script>alert("Account was successfully Aactivated!");window.location.href="systemadmin-page.php";</script>';
		}
		if($_SESSION['accesslevel'] == 'DEAN'){
			echo '<script>alert("Account was successfully Aactivated!");window.location.href="dean-page.php";</script>';
		}
	}
...
if (isset($_POST['resetpass'])) {
	$editoremail = $_SESSION['resemail'];
	$editorpass = $_SESSION['reslastname'];
	$editsql = "UPDATE user
		SET 
			password = '$editorpass'
		WHERE
	...
	mysqli_query($db, $editsql);
	if($_SESSION['accesslevel'] == 'SYSTEMADMIN'){
		echo '<script>alert("Account Password was successfully Reset to Default!");window.location.href="systemadmin-page.php";</script>';
	}
	if($_SESSION['accesslevel'] == 'DEAN'){
		echo '<script>alert("Account Password was successfully Reset to Default!");window.location.href="dean-page.php";</script>';
	}
}
