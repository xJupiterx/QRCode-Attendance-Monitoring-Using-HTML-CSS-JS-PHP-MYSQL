							...
							<table id="myTable" class="table table-bordered table-sm" cellspacing="0" width="100%">
								...
								<tbody>
									<tr>
                                        ...
                                        $_SESSION['reslastname'] = $row['lastname'];
                                        ...
                                        <td>
											<div class="clearfix">
												<center><input type="submit" name="resetpass" value="RESET" style = "background-color:gray; color:white" onclick="return  confirm('Do you really want to RESET password?')"></center>
											</div>
										</td>
									</tr>
								<?php
